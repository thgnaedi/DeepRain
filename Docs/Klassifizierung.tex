...
%    &                      & \textbf{Kein Regen} & \textbf{Regen}\\\hline
%\multirow{3}{*}{\rotatebox{90}{Daten}}
%    & \textbf{Kein Regen}  & 2323398 (,\%)    & 163631 (,\%)\\
%    & \textbf{Regen}       & 7068 (,\%)      & 57711 (,\%)\\
%\end{tabular}
...
%    &                      & \textbf{Kein Regen} & \textbf{Regen}\\\hline
%\multirow{3}{*}{\rotatebox{90}{Daten}}
%    & \textbf{Kein Regen}  & 2365886 (,\%)    & 121143 (,\%)\\
%    & \textbf{Regen}       & 10664 (,\%)      & 54115 (,\%)\\
%\end{tabular}
...
%    &                      & \textbf{Kein Regen} & \textbf{Regen}\\\hline
%\multirow{3}{*}{\rotatebox{90}{Daten}}
%    & \textbf{Kein Regen}  & 2436225 (,\%)    & 50804 (,\%)\\
%    & \textbf{Regen}       & 17672 (,\%)      & 47107 (,\%)\\
%\end{tabular}
...
%    &                      & \textbf{Kein Regen} & \textbf{Regen}\\\hline
%\multirow{3}{*}{\rotatebox{90}{Daten}}
%    & \textbf{Kein Regen}  & 2445930 (,\%)    & 41099 (,\%)\\
%    & \textbf{Regen}       & 20450 (,\%)      & 44329 (,\%)\\
%\end{tabular}
...
%    &                      & \textbf{Kein Regen} & \textbf{Regen}\\\hline
%\multirow{3}{*}{\rotatebox{90}{Daten}}
%    & \textbf{Kein Regen}  & 2475815 (,\%)    & 11214 (,\%)\\
%    & \textbf{Regen}       & 36827 (,\%)      & 27952 (,\%)\\
%\end{tabular}
