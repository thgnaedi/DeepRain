...
\hypersetup{
    pdfauthor    = {Thomas Gnädig, Etienne Gramlich, Tim Hardenacke, Merle Wolff},
    pdftitle     = {DeepRain},
...
\title{DeepRain}
\author{Thomas Gnädig, Etienne Gramlich, Tim Hardenacke, Merle Wolf}
...
% Datenaufbereitung
\input{Datenaufbereitung.tex}

% Datenanalyse
\input{Datenanalyse.tex}
% Netzwerke
